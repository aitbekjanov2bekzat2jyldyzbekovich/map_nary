    ...
    <div>
      ...
      <ul class="space-y-3 py-5">
        <li>
          <router-link
            to="/"
            class="flex items-center cursor-pointer p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full gap-4"
          >
            <svg
          ...
          <div class="w-full max-w-md mx-auto">
            ...
            <transition name="accordion">
              ...
              >
                <ol class="max-w-md space-y-3 text-gray-500 list-decimal list-inside dark:text-gray-400 text-sm">
                  <li>
                    ...
                    <div class="text-gray-800 dark:text-white flex items-center gap-5 text-lg flex-wrap">
                      <div><span>X: {{ cardinats[0] || 0 }}</span></div>
                      <div><span>Y: {{ cardinats[1] || 0 }}</span></div>
                    </div>
                  </li>
                  ...
                  <li class="space-y-1">
                    ...
                    <input
                      ...
                      type="text"
                      id="first_name"
                      placeholder="Токтогул ГЭС ......"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-700"
                      required
                    />
                  </li>

                  <li class="space-y-1">
                    <label for="message">Введите кароткую информацию о Э.С</label>
                    <textarea
                      v-model="formValue.description"
                      id="message"
                      rows="4"
                      placeholder="Какшаал ГЭС - это гидроэлектростанция, которая, ........"
                      class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-700"
                    ></textarea>
                  </li>

                  <li class="space-y-1">
                    <label for="place">Введите информацию о местоположении Э.С</label>
                    <input
                      v-model="formValue.place"
                      type="text"
                      id="place"
                      placeholder="Город Нарын итд."
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-700"
                      required
                    />
                  </li>
                  ...
                  <li class="space-y-1">
                    ...
                    <textarea
                      v-model="formValue.Purpose_of_construction"
                      id="sel"
                      rows="4"
                      placeholder="ГЭС призвана увеличить ......"
                      class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-700"
                    ></textarea>
                  </li>
                  ...
                  <li class="space-y-1">
                    <span>Добавьте изображение Э.C</span>
                ...
                <!-- Кнопки действий -->
                <div
                  v-show="formValue.images.length && formValue.category && formValue.statusEb.length && formValue.title && cardinats.length && formValue.Purpose_of_construction && formValue.description && formValue.place && formValue.partners"
                  class="bg-white dark:bg-gray-900 sticky bottom-[-1rem] left-0 pt-2 flex items-center justify-between border-t border-blue-700"
                >
                  <button
                    type="button"
                    v-show="!statusMarker"
                    @click="this.$emit('editMarker')"
